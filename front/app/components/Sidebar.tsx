...
import { BiEnvelope, BiBriefcase, BiSearch, BiTask, BiUserCircle, BiBrain, BiMoon, BiSun, BiSliderAlt, BiCheckShield } from 'react-icons/bi'
...
export default function Sidebar() {
  ...
  const envGroup = [
    ...
    { href: '/filter-template', icon: BiSliderAlt, label: '统一筛选', color: 'text-emerald-300' },
    { href: '/automation', icon: BiCheckShield, label: '自动化任务', color: 'text-amber-300' },
  ]
